...
class fcom_webmedios_tabs_Widget extends fcom_webmedios_dynamic_Widget {
     ...
     * @return void
     **/
    function fcom_webmedios_tabs_Widget() {
        $widget_ops = array( 'classname' => 'fcom_webmedios_tabs news-tab', 'description' => __('Despliega widgets dentro de pestañas', 'fcom_webmedios') );
        $this->WP_Widget( 'fcom_webmedios_tabs', 'FCOM UC: Tabs', $widget_ops );
    }

    function fcom_display_widgets_front($instance){
              ...
              <?php
                ...
                foreach ($widgets as $widget ) {
                  ...
                  if( !empty( $widget ) ) {
                    ...
                    $widget = $this->fcom_get_widgets( $s['id_base'], $i );
...
add_action( 'widgets_init', create_function( '', "register_widget('fcom_webmedios_tabs_Widget');" ) );
